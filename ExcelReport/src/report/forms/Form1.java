 ...
 */
public final class Form1 extends AFormFilter<List<Form1.AgentInfo>> {
  public Form1(@Nullable String sign, @Nullable Filter filter, @Nullable Boolean charge, @Nullable Boolean discount) throws ValidationException {
    super(EForm.FORM_1, null, sign, filter, charge, discount);
  }
  ...
  @NotNull
  public Form1 generateData(@Nullable List<OrderObj> orderList) throws ValidationException {
