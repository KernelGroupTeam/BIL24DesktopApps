 ...
 */
public final class Form15 extends AFormQuotaSeats<List<Form15.TotalInfo>> {
  public Form15(@Nullable String sign, @Nullable RAction action, @Nullable Set<Long> allowedSeatIdSet) throws ValidationException {
    super(EForm.FORM_15, null, sign, action, allowedSeatIdSet);
  }
  ...
  @NotNull
  public Form15 generateData(@Nullable List<OrderObj> orderList) throws ValidationException {
