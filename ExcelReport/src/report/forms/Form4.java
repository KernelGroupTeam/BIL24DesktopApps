 ...
 */
public final class Form4 extends AFormFilter<List<Form4.ActionEventInfo>> {
  public Form4(@Nullable String sign, @Nullable Filter filter, @Nullable Boolean charge, @Nullable Boolean discount) throws ValidationException {
    super(EForm.FORM_4, null, sign, filter, charge, discount);
  }
  ...
  @NotNull
  public Form4 generateData(@Nullable List<OrderObj> orderList) throws ValidationException {
