/*
 * $Id: JXSummaryTable.java,v 1.1 2006/08/03 14:21:58 rasto1968 Exp $
 *
 ...
 * @author Rob Stone
 */
@SuppressWarnings({"UnnecessaryFinalOnLocalVariableOrParameter", "DanglingJavadoc"})
public class JXSummaryTable extends JXTable {
     ...
     * See JXTable
     */
    public JXSummaryTable(Vector<Object> rowData, Vector<String> columnNames) {
